        ...
        <section className="mx-auto grid w-full max-w-[1200px] gap-6 px-4 py-14 sm:px-6 lg:grid-cols-2 lg:items-center lg:px-8">
          <div>
            ...
            <div className="mt-6 space-y-5 border-l-2 border-slate-300 pl-5">
              <div>
                <p className="inline-flex w-11 items-center justify-center rounded-full bg-[#0a469f] px-2 py-1 text-[10px] font-semibold text-white">
                  2008
                </p>
                ...
                <p className="text-xs text-slate-600">
                  Thành lập cơ sở khoan giếng gia đình đầu tiên tại Tuy Hòa với 1 máy khoan cơ bản.
                </p>
              </div>
              <div>
                <p className="inline-flex w-11 items-center justify-center rounded-full bg-[#7a4e1d] px-2 py-1 text-[10px] font-semibold text-white">
                  2015
                </p>
                ...
                <p className="text-xs text-slate-600">
                  Nhập khẩu hệ thống máy khoan thủy lực Nhật Bản, mở rộng quy mô phục vụ công nghiệp.
                </p>
              </div>
              <div>
                <p className="inline-flex w-11 items-center justify-center rounded-full bg-white px-2 py-1 text-[10px] font-semibold text-[#0a469f] ring-1 ring-[#0a469f]">
                  Nay
                </p>
                ...
                <p className="text-xs text-slate-600">
                  Đội ngũ 50+ kỹ thuật viên, sở hữu dàn thiết bị hiện đại nhất tỉnh Phú Yên.
                </p>
              </div>
            </div>
          </div>
