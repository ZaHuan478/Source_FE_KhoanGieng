      ...
      <div className="relative mx-auto flex min-h-svh w-full max-w-300 items-center px-4 pb-16 pt-24 sm:px-6 lg:px-8">
        <div className="max-w-xl animate-[fadeInUp_700ms_ease-out] text-shadow-[0_3px_14px_rgba(0,0,0,0.7)]">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <a
              href="#lien-he"
              className="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2.5 text-xs font-semibold text-blue-900 shadow-lg shadow-blue-950/30 transition duration-300 hover:-translate-y-0.5 hover:bg-blue-50"
            >
